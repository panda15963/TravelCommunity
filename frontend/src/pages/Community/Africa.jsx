    ...
    render() {
        return (
            <>
                <Menubar />
                <div>
                    <img src={`${process.env.PUBLIC_URL}/img/community/community_africa.jpg`} alt="" className="img-responsive" />
                    <h1 className="main-text">
                        Africa Community<br />
                        This is the Africa Community Page where you find all the Africa Experiences.
                    </h1>
                </div>
                <div className="table">
