    ...
    render() {
        return (
            <div>
                <Menubar />
                <div>
                    <img src={`${process.env.PUBLIC_URL}/img/community/community_na.jpg`} alt="" className="img-responsive" />
                    <h1 className="main-text">
                        North America Community<br />
                        This is the North America Community Page where you find all the North America Experiences.
                    </h1>
                </div>
                <div className="table">
