    ...
    render() {
        return (
            <div>
                <Menubar />
                <div>
                    <img src={`${process.env.PUBLIC_URL}/img/community/community_oceania.png`} alt="" className="img-responsive" />
                    <h1 className="main-text">
                        Oceania Community<br />
                        This is the Oceania Community Page where you find all the Oceania Experiences.
                    </h1>
                </div>
                <div className="table">
