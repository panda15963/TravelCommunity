    ...
    render() {
        return (
            <div>
                <Menubar />
                <div>
                    <img src={`${process.env.PUBLIC_URL}/img/community/community_sa.png`} alt="" className="img-responsive" />
                    <h1 className="main-text">
                        South America Community<br />
                        This is the South America Community Page where you find all the South America Experiences.
                    </h1>
                </div>
                <div className="table">
