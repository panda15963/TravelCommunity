    ...
    render() {
        return (
            <div>
                <Menubar />
                <div>
                    <img src={`${process.env.PUBLIC_URL}/img/community/community_europe.jpg`} alt="" className="img-responsive" />
                    <h1 className="main-text">
                        Europe Community<br />
                        This is the Europe Community Page where you find all the Europe Experiences.
                    </h1>
                </div>
                <div className="table">
